...
public class EventlogsFragment extends Fragment {
    ...
    private EventlogsViewModel eventlogsViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        eventlogsViewModel =
                ViewModelProviders.of(this).get(EventlogsViewModel.class);
        View root = inflater.inflate(R.layout.fragment_logs, container, false);
        final TextView textView = root.findViewById(R.id.text_send);
        eventlogsViewModel.getText().observe(this, new Observer<String>() {
            @Override
